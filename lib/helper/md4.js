// Copy source from https://github.com/emn178/js-md4/blob/master/src/md4.js
// Replaces crypto with crypto-js and use commonjs loader only
...
(function() {
   ...
   */
	Md4.prototype.update = function(message) {
		...
		let code; let index = 0; let i; const length = message.length || 0; const blocks = this.blocks;
	...
	Md4.prototype.hash = function() {
		let a; let b; let c; let d; let ab; let bc; let cd; let da; const blocks = this.blocks;
   ...
   */
	Md4.prototype.hex = function() {
		...
		const h0 = this.h0; const h1 = this.h1; const h2 = this.h2; const h3 = this.h3;
